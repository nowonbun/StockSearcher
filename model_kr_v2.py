...
class WindowIterableDatasetV2(IterableDataset):
    def __init__(
        ...
        reversal_close_vs_lowerband_max: float = 0.01,
        reversal_band_pos_max: float = 0.18,
        reversal_drawdown20_max: float = -0.08,
        reversal_min_weakness_score: int = 3,
        reversal_min_ha_body_ratio: float = 0.35,
    ):
        super().__init__()
        self.table = table
        self.codes = codes
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max-drawdown", type=float, default=0.06)
    ...
    parser.add_argument("--reversal-close-vs-lowerband-max", type=float, default=0.01)
    parser.add_argument("--reversal-band-pos-max", type=float, default=0.18)
    parser.add_argument("--reversal-drawdown20-max", type=float, default=-0.08)
    parser.add_argument("--reversal-min-weakness-score", type=int, default=3)
    parser.add_argument("--reversal-min-ha-body-ratio", type=float, default=0.35)
    ...
    parser.add_argument("--model-out", default="model_kr_v2.pt")
    ...
    parser.add_argument("--threshold-sweep-start", type=float, default=0.45)
    parser.add_argument("--threshold-sweep-end", type=float, default=0.80)
    parser.add_argument("--threshold-sweep-step", type=float, default=0.05)
    parser.add_argument("--pos-rate", type=float, default=0.03)
    parser.add_argument("--pos-weight-max", type=float, default=0)
