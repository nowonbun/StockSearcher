...
from model_kr import _RAW_COLS, StockTransformer, load_codes
from model_jp import load_model_checkpoint
from model_kr_v2 import V2_FEATURE_COLS, V2_MODEL_MODE, compute_v2_features
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model", default="model_kr_v2.pt")
