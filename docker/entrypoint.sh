...
CRON_SCHEDULE_JP="${CRON_SCHEDULE_JP:-${CRON_SCHEDULE_JP2:-0 2 * * *}}"
CRON_SCHEDULE_KR="${CRON_SCHEDULE_KR:-${CRON_SCHEDULE_KR2:-0 4 * * *}}"
JOB_CMD_JP="${JOB_CMD_JP:-${JOB_CMD_JP2:-python dataset_jp.py && python predict_jp.py --model /models/model_jp.pt --save-db}}"
JOB_CMD_KR="${JOB_CMD_KR:-${JOB_CMD_KR2:-python dataset_kr.py && python predict_kr.py --model /models/model_kr.pt --save-db}}"
