...
V2_MODEL_MODE = "v2_reversal_week_jp"
V2_FEATURE_COLS = [
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model-out", default="model_week_jp_v2.pt")
    ...
    parser.add_argument("--threshold-sweep-start", type=float, default=0.50)
    ...
    parser.add_argument("--pos-rate", type=float, default=0.05)
