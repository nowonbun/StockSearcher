...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model", default="model_week_jp.pt")
    ...
    parser.add_argument("--min-close-vs-ma20", type=float, default=-0.02, help="close_vs_ma20 최소값 (model_week_jp.py trend label 기본값과 일치)")
    parser.add_argument("--min-close-vs-ma60", type=float, default=None, help="close_vs_ma60 최소값 (학습 라벨 외 추가 보수 필터가 필요할 때만 사용)")
    parser.add_argument("--min-ma20-slope", type=float, default=-0.01, help="ma20_slope_5 최소값 (model_week_jp.py trend label 기본값과 일치)")
    parser.add_argument("--min-ma60-slope", type=float, default=-0.01, help="ma60_slope_10 최소값 (model_week_jp.py trend label 기본값과 일치)")
