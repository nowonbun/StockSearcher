...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--min-close-vs-ma20", type=float, default=None, help="close_vs_ma20 최소값 (model_jp.py trend label 기본값과 일치)")
    parser.add_argument("--min-close-vs-ma60", type=float, default=None, help="close_vs_ma60 최소값 (학습 라벨 외 추가 보수 필터가 필요할 때만 사용)")
    parser.add_argument("--min-ma20-slope", type=float, default=None, help="ma20_slope_5 최소값 (model_jp.py trend label 기본값과 일치)")
    parser.add_argument("--min-ma60-slope", type=float, default=None, help="ma60_slope_10 최소값 (model_jp.py trend label 기본값과 일치)")
